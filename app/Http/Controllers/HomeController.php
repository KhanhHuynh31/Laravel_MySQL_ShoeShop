...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('pages.home')->with('category', $cate_product)->with('brand', $brand_product)->with('size', $size_product)->with('hot_product', $hot_product)->with('new_product', $new_product)->with('city', $city);
    }
